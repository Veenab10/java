public class CameraRunner{
    ...
    public static void main(String args[])
    {
        ...
        Camera camera5=new Camera("Panasonic",65000,5600, CameraType.BRIDGE, BatteryType.LITHIUM, ChargingType.USBC, DisplayType.LCD, 1989,features);
        camera5.display();
        for(int i=0;i<features.length;i++)
        {
            System.out.println(features[i]);
        }
        CameraType type1=CameraType.NIKON;
